...
<head>
    ...
    <meta name="Autor" content="Miguel S.">
    <link rel="stylesheet" href="<?php echo BASE_URL ?>Assets/css/estilo.css">
    <link rel="stylesheet" href="<?php echo BASE_URL ?>Assets/css/bodyStyle.css">
    ...
    <title>Venta de smartphone online</title>
...
<body>
    ...
    <nav class="header">
        ...
        <ul class="nav-links">
            ...
            <li><a class="btn" href="#">Productos</a></li>
            <li><a class="btn" href="#">Services</a></li>
            <li><a class="btn" href="#">Contactanos</a></li>
